...
Para obtener más información, consulte https://library.netapp.com/ecm/ecm_download_file/ECMLP2886542["Notas de la versión de ONTAP tools para VMware vSphere 10,0"^].
